...
def get_loaders(dir_, batch_size, args, prob=0.0):
    if args.single_mode == "apr":
        train_transform = transforms.Compose([
        transforms.RandomApply([APRecombination()], p=prob),
        ...
        train_transform = transforms.Compose([
        transforms.RandomApply([HybridAugmentSingle()], p=1.0),
        transforms.RandomCrop(32, padding=4),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
        transforms.Normalize(cifar10_mean, cifar10_std),
        ...
        train_transform = transforms.Compose([
        transforms.RandomApply([HybridAugmentPlusSingle()], p=1.0),
        transforms.RandomCrop(32, padding=4),
        transforms.RandomHorizontalFlip(),
        transforms.ToTensor(),
        transforms.Normalize(cifar10_mean, cifar10_std),
